...
export default function Checkout() {
  ...
  const submitShipping = (e) => { e.preventDefault(); setStep(2); window.scrollTo(0, 0) }
  const submitPayment = (e) => {
    e.preventDefault()
    setLoading(true)
    setTimeout(() => { setLoading(false); setStep(3); clearCart(); window.scrollTo(0, 0) }, 1800)
  }
  ...
  if (step === 3) return (
    <div className="page-enter min-h-[70vh] flex items-center justify-center px-8">
      <div className="max-w-sm w-full text-center">
        ...
        >✓</motion.div>
        <h1 className="font-display font-black text-4xl mb-3" style={{ color: 'var(--text)' }}>Order placed!</h1>
        <p className="font-mono text-[13px] mb-2" style={{ color: 'var(--text-3)' }}>Order {orderNum}</p>
  ...
  return (
    <div className="page-enter">
      <div className="container-page py-12">
        ...
        <h1 className="font-display font-black text-4xl md:text-5xl mb-8" style={{ color: 'var(--text)' }}>
          Checkout
        </h1>
          ...
          <div className="lg:col-span-3">
            <AnimatePresence mode="wait">
              ...
              {step === 1 && (
                ...
                >
                  <div>
                    <p className="font-mono text-[12px] uppercase tracking-widest mb-4" style={{ color: 'var(--text-3)' }}>Contact</p>
                    <Input label="Email address" type="email" required placeholder="you@example.com" {...f('email')} />
                  </div>

                  <div>
                    <p className="font-mono text-[12px] uppercase tracking-widest mb-4" style={{ color: 'var(--text-3)' }}>Shipping address</p>
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[12px] font-mono uppercase tracking-widest" style={{ color: 'var(--text-3)' }}>Country</label>
                        <select
                          required
                          ...
                          {...f('country')}
                        >
                          {[['US', 'United States'], ['CA', 'Canada'], ['GB', 'United Kingdom'], ['JP', 'Japan'], ['TW', 'Taiwan'], ['AU', 'Australia']].map(([v, l]) => (
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <p className="font-mono text-[12px] uppercase tracking-widest" style={{ color: 'var(--text-3)' }}>Payment</p>
                  ...
                  <div className="flex gap-3 mt-2">
                    <Button type="button" variant="outline" size="lg" className="flex-1 justify-center" onClick={() => setStep(1)}>
                      ← Back
                    </Button>
                    <Button
                      type="submit"
          ...
          <div className="lg:col-span-2">
            ...
            >
                ...
                {items.map((item) => (
                  <div key={item.key} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-mono text-[12px]" style={{ color: 'var(--text-3)' }}>Size: {item.size}</p>
                    </div>
              ...
              <div className="flex flex-col gap-2 pt-4" style={{ borderTop: '1px solid var(--border-soft)' }}>
                ...
                <div className="flex justify-between pt-3 text-[16px] font-semibold" style={{ borderTop: '1px solid var(--border-soft)' }}>
